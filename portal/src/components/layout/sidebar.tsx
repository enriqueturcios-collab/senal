...
export function Sidebar({ institutionName, plan }: SidebarProps) {
    ...
    <aside className="flex flex-col w-64 min-h-screen bg-brand-900 text-white">
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-white/10">
        ...
        <div className="min-w-0">
          <div className="font-bold text-sm truncate">Señal Intelligence</div>
          <div className="text-xs text-white/50 truncate">{institutionName}</div>
        </div>
      </div>
      ...
      <div className="px-6 py-4 border-t border-white/10">
        <div className="flex items-center justify-between text-xs">
          <span className="text-white/40">Plan activo</span>
          <span className="font-semibold text-white/80 uppercase tracking-wide">{plan}</span>
        </div>
      </div>
    </aside>
  )
